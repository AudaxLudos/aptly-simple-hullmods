...
public class FluxAmplifiers extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        tooltip.addPara("Increases the damage of non-missile weapons by %s.", oPad, good, Math.round(WEAPON_DAMAGE_MULT * 100f) + "%");
        tooltip.addPara("Increases the flux cost of non-missile weapons by %s.", pad, bad, Math.round(WEAPON_FLUX_MULT * 100f) + "%");
