...
public class ConvictedCrewmates extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        tooltip.addPara("Gain %s/%s/%s/%s seconds of peak performance time based on the targets hull size.", pad, good,
        ...
        tooltip.addPara("Frigates gain %s the peak performance time against larger ships.", pad, good, FRIGATE_PPT_MULT + " Times");
        tooltip.addPara("Destroyers gain %s the peak performance time against larger ships.", pad, good, DESTROYER_PPT_MULT + " Times");
        tooltip.addPara("Targets must die within %s to gain peak performance time bonuses.", pad, good, Math.round(KILL_TIMER) + " seconds");
