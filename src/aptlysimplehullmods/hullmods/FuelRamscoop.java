...
public class FuelRamscoop extends BaseLogisticsHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        tooltip.setBulletedListMode(" ^ ");
        tooltip.addPara("Generates %s based on hull size", pad, good, Math.round(FUEL_TO_GENERATE.get(HullSize.FRIGATE).intValue()) + "/"
                + Math.round(FUEL_TO_GENERATE.get(HullSize.DESTROYER).intValue()) + "/"
                + Math.round(FUEL_TO_GENERATE.get(HullSize.CRUISER).intValue()) + "/"
                + Math.round(FUEL_TO_GENERATE.get(HullSize.CAPITAL_SHIP).intValue()) + " fuel");
